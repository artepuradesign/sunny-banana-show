...
</header><main><center><form action="chavecadastrada.php" method="POST">
CPF / Chave Pix &nbsp; <a href="cadastrochavepixcnpj.php" class="cadastro">* CNPJ *</a> 
<br>
<br>
<input type="text" id="chave" name="chave" placeholder="Chave Pix" maxlength="500">
<input type="text" id="cpf" name="cpf" placeholder="CPF" maxlength="11" inputmode="numeric">
<input type="text" id="nome" name="nome" placeholder="Primeiro Nome" maxlength="50">
